...
export default async function division(
  ...
  if (easyQuestion === undefined) {
    ...
    // adjust the operand for integer answer
    easyQuestion.operandTwo += 1;
    easyQuestion.operandOne = easyQuestion.operandOne * easyQuestion.operandTwo;
    mediumQuestion.operandOne =
      mediumQuestion.operandOne * mediumQuestion.operandTwo;
    hardQuestion.operandOne = hardQuestion.operandOne * hardQuestion.operandTwo;
  ...
  if (!result) {
    displayResult(result);
    setTimeout(() => {
      division(difficulty, easyQuestion, mediumQuestion, hardQuestion);
    }, 1000);
  }
}
